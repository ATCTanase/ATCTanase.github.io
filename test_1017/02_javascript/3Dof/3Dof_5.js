...
videoPlane2.addEventListener("loaded", () => {
    ...
    videoPlane2.setAttribute("height", vpWidth * offset2);
...
videoPlane3.addEventListener("loaded", () => {
    ...
    videoPlane3.setAttribute("height", vpWidth * offset3);
    ...
    array.forEach(function (value) {
        ...
        if (content[0].trim(" ") == "arPosition5_3") {
            ...
            marker3PositionX = arPosition[0];
            marker3PositionY = arPosition[1];
            marker3PositionZ = arPosition[2];
        }
        ...
        if (content[0].trim(" ") == "arHeightWidth5_3") {
            ...
            videoPlane3.setAttribute("height", arHeightWidth[1] * offset3);
