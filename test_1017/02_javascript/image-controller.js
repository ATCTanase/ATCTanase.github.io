...
function setContentsExplanation(){
  $("#explanationBackgroud1").attr( "src", CONTENTS_EXPLANATION_BG1);
  $("#explanationBackgroud2").attr( "src", CONTENTS_EXPLANATION_BG2);
  $("#explanationBackgroud3").attr( "src", CONTENTS_EXPLANATION_BG3);
  $("#explanationBackgroud4").attr( "src", CONTENTS_EXPLANATION_BG4);
  $("#explanationBackgroud5").attr( "src", CONTENTS_EXPLANATION_BG5);
  $("#explanationBackgroud6").attr( "src", CONTENTS_EXPLANATION_BG6);
  $("#explanationBackgroud7").attr( "src", CONTENTS_EXPLANATION_BG7);
  $("#explanationBackgroud8").attr( "src", CONTENTS_EXPLANATION_BG8);
  $("#explanationBackgroud9").attr( "src", CONTENTS_EXPLANATION_BG9);
  $("#explanationBackgroud10").attr("src", CONTENTS_EXPLANATION_BG10);
  $("#explanationBackgroud11").attr("src", CONTENTS_EXPLANATION_BG11);
  $("#explanationBackgroud12").attr("src", CONTENTS_EXPLANATION_BG12);
